...
export default function AboutSection() {
  return (
    <section className="bg-light py-16 px-4 text-neutral">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-base md:text-lg leading-relaxed mb-6">
          ...
          construção e reforma, a <strong>ConstruLoja</strong> é referência na
          região por seu atendimento diferenciado, variedade de produtos e
          tradição no mercado.
        </p>
